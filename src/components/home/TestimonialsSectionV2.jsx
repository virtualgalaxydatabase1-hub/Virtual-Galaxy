  ...
  return (
    <div className="box-black">
      ...
      <img
        ...
        alt="light effect top"
      />
      <img
        className="light-bot"
        src="/assets/images/item/light-bot.png"
        alt="light effect bottom"
      />
        ...
        <div className="container">
          ...
          <div className="testimonials-v2-wrap">
                  ...
                  <div className="swiper-wrapper">
                    ...
                    <div className="swiper-slide">
                      <div>
                        ...
                        <div className="text-body-1 text-white desc">
                          We shipped our first copilot in 7 weeks and cut support tickets by 31%.
                        </div>

                        <div className="cite mb-0">
                          <img
                            className="line-left"
                            src="/assets/images/item/line-1.png"
                            alt=""
                          />
                    ...
                    <div className="swiper-slide">
                      <div>
                        ...
                        <div className="text-body-1 text-white desc">
                          SSO/SAML and RBAC landed smoothly. Latency stayed &lt;300 ms.
                        </div>
                    ...
                    <div className="swiper-slide">
                      <div>
                        ...
                        <div className="text-body-1 text-white desc">
                          The best partner for agentic work. Multi-step planning and audit trails—done right.
                        </div>
            ...
            <div className="col-right">
              <div className="swiper sw-main-image">
                <div className="swiper-wrapper">
                  <div className="swiper-slide">
